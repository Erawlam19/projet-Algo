###########################################################
#
#           TD Algorithmique avancée : semestre 2
#               Raphaël DULONG & Paul RICHIARDI
...
def search(Noeud,key):
    ...
    # La recherche est plus grande que la valeur du noeud courant
    elif Noeud.valeur < key:
        return search(Noeud.filsGauche,key)
   
    # La recherche est plus petite que la valeur du noeud courant
    else:
